...
// capture the 2 inputs entered in the form (email & password) using the $_POST superglobal variable
// assign these values to 2 new local variables $email & $password
$email = $_POST['1_email'];
...
// echo "<p class = 'updateInfo'>Login password: ".$password."</p>";
