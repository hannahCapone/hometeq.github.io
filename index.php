...
while ($arrayp=mysqli_fetch_array($exeSQL))
{
    ...
    echo "<p><h5>".$arrayp['prodDescripShort']."</h5></p>"; //display product name as contained in the array
    echo "<p><h5>$".$arrayp['prodPrice']."</h5></p>"; //display product name as contained in the array
    echo "</td>";
    echo "</tr>";
}
echo "</table>";
